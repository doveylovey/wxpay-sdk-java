 ...
 */
@Data
public class WxpayCreateRentBillNotify {
    /**
     * 商户号
     */
     ...
     * @return
     */
    public WxpayCreateRentBillNotifyPlaintext decrypt(String apiv3Key) throws Exception {
        String decryptText = AESGcmUtil.aesGcmDecrypt(apiv3Key, eventAssociatedData, eventNonce, eventCiphertext);
        return XMLParser.getObjFromXML(decryptText, WxpayCreateRentBillNotifyPlaintext.class);
    }
}
