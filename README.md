# wxpay-sdk-java
本项目是根据其他项目改编而来的，原项目地址：https://gitee.com/snailhd/snailhd-pay-wx-sdk.git

#### 介绍
微信支付 sdk for java，提供封装了请求响应对象，方便调用，支持 SYSTEMERROR 重试，和简单的域名主备切换

#### 使用 demo

##### 微信支付请求 demo，各接口请求参数请参照微信支付文档
 * 微信支付文档：https://pay.weixin.qq.com/wiki/doc/api/index.html
 * 微信支付分文档：https://pay.weixin.qq.com/wiki/doc/apiv3/payscore.php?chapter=12_2&index=1
 
```java
public class WxPayTestsConfig {
